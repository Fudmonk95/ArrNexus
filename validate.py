...
def main() -> int:
    ...
    require('APP_VERSION = "8.0.0-beta"' in main_source, "v8 beta version string missing")

    print("PASS: ArrNexus v8.0.0-beta retains all v7 regressions and safely adds AIOStreams full-config preview/apply/backup/rollback/search integration")
    return 0
