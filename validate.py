...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="arrnexus-v94-validate-") as tmp:
        ...
        with TestClient(main_app.app) as client:
            ...
            require(landing.status_code == 200 and "Help Centre" in landing.text and "WHAT'S NEW IN V9.4" in landing.text, "v9.4 landing Help integration")
            ...
            require(dashboard.status_code == 200, "private dashboard after setup")
            require("/help?topic=dashboard" in dashboard.text, "Dashboard contextual Help button")
    ...
    require('APP_VERSION = "9.4.0-beta"' in main_source, "v9.4 version string missing")
    ...
    require("arrnexus-static-v9.4" in sw, "v9.4 service-worker cache marker missing")
    ...
    require("Application routes/actions audited: **120**" in audit, "Documentation audit does not cover the full route/action surface")
