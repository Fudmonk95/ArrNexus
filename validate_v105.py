...
def main() -> int:
    ...
    with TestClient(main_app.app) as client:
        ...
        require(health.status_code == 200 and health.json().get("version") == "10.5.0-beta", "v10.5 health/version")
    ...
    require('APP_VERSION = "10.5.0-beta"' in main_source, "v10.5 application marker missing")
    ...
    require("arrnexus-static-v10.5.0" in sw, "v10.5 service-worker cache marker missing")
