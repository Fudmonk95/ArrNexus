...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="arrnexus-v102-validate-") as tmp:
        ...
        with TestClient(main_app.app) as client:
            ...
            require(health.status_code == 200 and health.json().get("version") == "10.2.0-beta", "v10.2 health/version")
    ...
    require('APP_VERSION = "10.2.0-beta"' in main_source, "v10.2 version string missing")
    ...
    require("arrnexus-static-v10.2" in sw, "v10.2 service-worker cache marker missing")
