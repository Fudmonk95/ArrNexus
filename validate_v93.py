...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(ignore_cleanup_errors=True, prefix="arrnexus-v93-validate-") as tmp:
        ...
        with TestClient(main_app.app) as client:
            ...
            for text in (
                ...
                "python3 -m venv .venv", "Music API Settings", "WHAT'S NEW IN V9.",
            ):
