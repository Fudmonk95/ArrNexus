...
def main() -> int:
    ...
    require(('APP_VERSION = "10.4.0-beta"' in main_source) or ('APP_VERSION = "10.4.1-beta"' in main_source) or ('APP_VERSION = "10.4.2-beta"' in main_source) or ('APP_VERSION = "10.4.3-beta"' in main_source) or ('APP_VERSION = "10.4.4-beta"' in main_source) or ('APP_VERSION = "10.5.0-beta"' in main_source) or (('APP_VERSION = "10.5.1-beta"' in main_source) or (('APP_VERSION = "10.6.0-beta"' in main_source) or ('APP_VERSION = "10.6.1-beta"' in main_source))), "v10.4+ version marker missing")
    ...
    require((('arrnexus-static-v10.4' in sw) or ('arrnexus-static-v10.4.1' in sw) or ('arrnexus-static-v10.5.0' in sw)) or ("arrnexus-static-v10.5.1" in sw) or ("arrnexus-static-v10.6.0" in sw) or ("arrnexus-static-v10.6.1" in sw), "v10.4+ service-worker cache marker missing")
