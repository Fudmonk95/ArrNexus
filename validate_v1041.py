...
def main() -> int:
    ...
    with TestClient(main_app.app) as client:
        ...
        require(health.status_code == 200 and health.json().get("version") == "10.4.1-beta", "v10.4.1 health/version")
    ...
    for marker in ('APP_VERSION = "10.4.1-beta"', 'run_archive_verify_job', '/maintenance/archives/verify', 'selected_media = [str(x) for x in form.getlist("media_path")'):
    ...
    require('arrnexus-static-v10.4.1' in sw, "v10.4.1 service-worker cache marker missing")
