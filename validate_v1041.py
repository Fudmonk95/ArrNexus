...
def main() -> int:
    ...
    require(any(v in main_source for v in ('APP_VERSION = "10.4.1-beta"', 'APP_VERSION = "10.4.2-beta"', 'APP_VERSION = "10.4.3-beta"', 'APP_VERSION = "10.4.4-beta"', 'APP_VERSION = "10.5.0-beta"', 'APP_VERSION = "10.5.1-beta"', 'APP_VERSION = "10.6.0-beta"', 'APP_VERSION = "10.6.1-beta"')), "v10.4.1+ version marker missing")
    ...
    require((('arrnexus-static-v10.4.1' in sw) or ('arrnexus-static-v10.4.2' in sw) or ('arrnexus-static-v10.4.3' in sw) or ('arrnexus-static-v10.4.4' in sw) or ('arrnexus-static-v10.5.0' in sw)) or ("arrnexus-static-v10.5.1" in sw) or ("arrnexus-static-v10.6.0" in sw) or ("arrnexus-static-v10.6.1" in sw), "v10.4.1+ service-worker cache marker missing")
