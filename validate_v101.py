...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(ignore_cleanup_errors=True, prefix="arrnexus-v101-validate-") as tmp:
        ...
        with TestClient(main_app.app) as client:
            ...
            require(health.status_code == 200 and version_key(str(health.json().get("version") or "0")) >= version_key("10.1.0-beta"), "v10.1 health/version")
    ...
    require(any(f'APP_VERSION = \"{v}\"' in main_source for v in ('10.1.0-beta','10.2.0-beta','10.3.0-beta','10.4.0-beta','10.4.1-beta','10.4.2-beta','10.4.3-beta','10.4.4-beta','10.5.0-beta','10.5.1-beta','10.6.0-beta','10.6.1-beta')), "v10.1+ version string missing")
    ...
    require((("arrnexus-static-v10.1" in sw or "arrnexus-static-v10.2" in sw or "arrnexus-static-v10.3" in sw or "arrnexus-static-v10.4" in sw or "arrnexus-static-v10.4.1" in sw or "arrnexus-static-v10.5.0" in sw)) or ("arrnexus-static-v10.5.1" in sw) or ("arrnexus-static-v10.6.0" in sw) or ("arrnexus-static-v10.6.1" in sw), "v10.1+ service-worker cache marker missing")
