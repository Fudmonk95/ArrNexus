...
def main() -> int:
    ...
    require(any(f'APP_VERSION = \"{v}\"' in main_source for v in ('10.1.0-beta','10.2.0-beta','10.3.0-beta','10.4.0-beta')), "v10.1+ version string missing")
    ...
    require(("arrnexus-static-v10.1" in sw or "arrnexus-static-v10.2" in sw or "arrnexus-static-v10.3" in sw or "arrnexus-static-v10.4" in sw), "v10.1+ service-worker cache marker missing")
