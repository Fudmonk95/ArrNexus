...
async def probe_builtin(kind: str, url: str, token: str) -> dict:
    ...
    headers = {"Accept": "application/json, application/xml;q=0.9, */*;q=0.5", "User-Agent": "ArrNexus/9.4"}
...
async def probe_custom(row: dict) -> dict:
    ...
    headers = {"User-Agent": "ArrNexus/9.4", "Accept": "application/json, text/plain, text/html;q=0.8, */*;q=0.5"}
    params = {}
