...
def main() -> int:
    ...
    require('APP_VERSION = "10.5.1-beta"' in main_source, "v10.5.1 application marker missing")
    ...
    require("arrnexus-static-v10.5.1" in (root / "app/static/sw.js").read_text(), "v10.5.1 service worker marker missing")
