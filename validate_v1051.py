...
def main() -> int:
    ...
    require(any(v in main_source for v in ('APP_VERSION = \"10.5.1-beta\"', 'APP_VERSION = \"10.6.0-beta\"', 'APP_VERSION = \"10.6.1-beta\"', 'APP_VERSION = \"10.6.2-beta\"', 'APP_VERSION = \"10.6.3-beta\"')), "v10.5.1+ application marker missing")
    ...
    require(any(x in (root / "app/static/sw.js").read_text() for x in ("arrnexus-static-v10.5.1", "arrnexus-static-v10.6.0", "arrnexus-static-v10.6.1", "arrnexus-static-v10.6.2", "arrnexus-static-v10.6.3")), "v10.5.1+ service worker marker missing")
