...
def main() -> int:
    ...
    with TestClient(main_app.app) as client:
        ...
        require(health.status_code == 200 and health.json().get("version") in {"10.4.3-beta", "10.4.4-beta", "10.5.0-beta", "10.5.1-beta", "10.6.0-beta"}, "v10.4.3 health/version")
    ...
    require(any(v in main_source for v in ('APP_VERSION = "10.4.3-beta"', 'APP_VERSION = "10.4.4-beta"', 'APP_VERSION = "10.5.0-beta"', 'APP_VERSION = "10.5.1-beta"', 'APP_VERSION = "10.6.0-beta"')), "v10.4.3+ application marker missing")
    ...
    require((("arrnexus-static-v10.4.3" in sw) or (("arrnexus-static-v10.4.4" in sw) or ("arrnexus-static-v10.5.0" in sw))) or ("arrnexus-static-v10.5.1" in sw) or ("arrnexus-static-v10.6.0" in sw), "v10.4.3+ service worker marker missing")
