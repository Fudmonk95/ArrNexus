...
def main() -> int:
    ...
    require(("arrnexus-static-v10.3" in sw or "arrnexus-static-v10.4" in sw or "arrnexus-static-v10.4.1" in sw or "arrnexus-static-v10.5.0" in sw) or ("arrnexus-static-v10.5.1" in sw) or ("arrnexus-static-v10.6.0" in sw) or ("arrnexus-static-v10.6.1" in sw), "v10.3+ service-worker cache marker missing")
