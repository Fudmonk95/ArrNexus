...
def main() -> int:
    ...
    async def fake_exact(source_pack_path: str, source_size_bytes: int = 0):
        return {"ok": True, "torrent": {"id": "rd-v106", "filename": "Known Good Pack"}, "matched_by": "exact filename"}
    ...
    require('APP_VERSION = "10.6.0-beta"' in main_source, "v10.6 application marker missing")
    ...
    require("arrnexus-static-v10.6.0" in (root / "app/static/sw.js").read_text(encoding="utf-8"), "v10.6 service-worker cache marker missing")
    ...
    try:
        with TestClient(main_app.app) as client:
            ...
            require(health.status_code == 200 and health.json().get("version") == "10.6.0-beta", "v10.6 health/version failed")
    finally:
