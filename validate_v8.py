...
def main() -> int:
    ...
    require(any(v in main_source for v in ('APP_VERSION = \"9.2.0-beta\"','APP_VERSION = \"9.1.0-beta\"','APP_VERSION = \"9.0.0-beta\"','APP_VERSION = \"8.0.0-beta\"')), "v8/v9 beta version string missing")
