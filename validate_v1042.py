...
def main() -> int:
    ...
    require(any(marker in lang_key for marker in ("language:v1042:", "language:v1043:", "language:v105:")), "Language Guard cache schema is older than v10.4.2")
    ...
    with TestClient(main_app.app) as client:
        ...
        require(health.status_code == 200 and health.json().get("version") in {"10.4.2-beta", "10.4.3-beta", "10.4.4-beta", "10.5.0-beta", "10.5.1-beta", "10.6.0-beta", "10.6.1-beta", "10.6.2-beta"}, "v10.4.2 health/version")
    ...
    require(('APP_VERSION = "10.4.2-beta"' in main_source) or ('APP_VERSION = "10.4.3-beta"' in main_source) or ('APP_VERSION = "10.4.4-beta"' in main_source) or ('APP_VERSION = "10.5.0-beta"' in main_source) or (('APP_VERSION = "10.5.1-beta"' in main_source) or (('APP_VERSION = "10.6.0-beta"' in main_source) or ('APP_VERSION = "10.6.1-beta"' in main_source) or ('APP_VERSION = "10.6.2-beta"' in main_source))), "v10.4.2+ application marker missing")
    ...
    require((("arrnexus-static-v10.4.2" in sw) or ("arrnexus-static-v10.4.3" in sw) or (("arrnexus-static-v10.4.4" in sw) or ("arrnexus-static-v10.5.0" in sw))) or ("arrnexus-static-v10.5.1" in sw) or ("arrnexus-static-v10.6.0" in sw) or ("arrnexus-static-v10.6.1" in sw) or ("arrnexus-static-v10.6.2" in sw), "v10.4.2+ service worker marker missing")
