...
def main() -> int:
    ...
    with TestClient(main_app.app) as client:
        ...
        require(health.status_code == 200 and health.json().get("version") in {"10.4.2-beta", "10.4.3-beta"}, "v10.4.2 health/version")
    ...
    require(('APP_VERSION = "10.4.2-beta"' in main_source) or ('APP_VERSION = "10.4.3-beta"' in main_source), "v10.4.2+ application marker missing")
    ...
    require(("arrnexus-static-v10.4.2" in sw) or ("arrnexus-static-v10.4.3" in sw), "v10.4.2+ service worker marker missing")
