...
def main() -> int:
    ...
    with TestClient(main_app.app) as client:
        ...
        require(health.status_code == 200 and health.json().get("version") == "10.4.4-beta", "v10.4.4 health/version")
    ...
    require('APP_VERSION = "10.4.4-beta"' in main_source, "v10.4.4 application marker missing")
    ...
    require("arrnexus-static-v10.4.4" in sw, "v10.4.4 service worker marker missing")
